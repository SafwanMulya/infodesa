...
<body>
    ...
    <div class="nomor">Nomor: 470/PEM/SKD/VII/2025/07</div>
    ...
    <div class="content">
        ...
        <p class="indent">
            Berdasarkan pengakuan yang bersangkutan benar berdomisili di {{ $data->alamat_domisili }}
            yang berada di wilayah Desa Tameran Kecamatan Bengkalis Kabupaten Bengkalis.
        </p>
        <p class="indent">
            Demikian surat keterangan domisili ini dibuat dengan sebenarnya dan diberikan untuk
    ...
    <div class="ttd">
        ...
        <br><br><br>
        <p><b><u>{{ $kepala_desa }}</u></b><br>NIP. - </p>
    </div>
</body>
</html>
